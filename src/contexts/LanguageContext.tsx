...
export const useLanguage = () => {
  ...
  privacyPolicyIntroduction: {
    el: 'Αυτή η πολιτική περιγράφει πώς το [website] συλλέγει, χρησιμοποιεί και προστατεύει τα προσωπικά δεδομένα σας.',
    en: 'This policy describes how [website] collects, uses, and protects your personal data.',
    de: 'Diese Richtlinie beschreibt, wie [website] Ihre personenbezogenen Daten erhebt, verwendet und schützt.'
  },
  ...
  privacyPolicyInfoWeCollectText: {
    el: 'Συλλέγουμε δεδομένα που παρέχετε μέσω φορμών και αυτόματα μέσω cookies.',
    en: 'We collect data you provide through forms and automatically via cookies.',
    de: 'Wir erfassen Daten, die Sie über Formulare bereitstellen, und automatisch über Cookies.'
  },
  ...
  privacyPolicyHowWeUseInfoText: {
    el: 'Χρησιμοποιούμε τα δεδομένα για την παροχή υπηρεσιών και την επικοινωνία μαζί σας.',
    en: 'We use the data to provide services and communicate with you.',
    de: 'Wir verwenden die Daten, um Dienstleistungen bereitzustellen und mit Ihnen zu kommunizieren.'
  },
  ...
  privacyPolicyDataStorageText: {
    el: 'Τα δεδομένα σας αποθηκεύονται με ασφάλεια στους διακομιστές μας.',
    en: 'Your data is securely stored on our servers.',
    de: 'Ihre Daten werden sicher auf unseren Servern gespeichert.'
  },
  ...
  privacyPolicyDataSharingText: {
    el: 'Δεν μοιραζόμαστε τα δεδομένα σας με τρίτους χωρίς τη συγκατάθεσή σας.',
    en: 'We do not share your data with third parties without your consent.',
    de: 'Wir geben Ihre Daten nicht ohne Ihre Zustimmung an Dritte weiter.'
  },
  ...
  privacyPolicyYourRightsText: {
    el: 'Μπορείτε να ζητήσετε πρόσβαση, διόρθωση ή διαγραφή των δεδομένων σας.',
    en: 'You can request access, correction, or deletion of your data.',
    de: 'Sie können den Zugriff, die Berichtigung oder Löschung Ihrer Daten anfordern.'
  },
  ...
  privacyPolicyCookiesSectionText: {
    el: 'Χρησιμοποιούμε cookies για βελτίωση της εμπειρίας χρήστη.',
    en: 'We use cookies to enhance user experience.',
    de: 'Wir verwenden Cookies, um die Benutzererfahrung zu verbessern.'
  },
  privacyPolicyChangesTitle: {
    el: 'Αλλαγές στην Πολιτική Απορρήτου',
    en: 'Changes to Privacy Policy',
    de: 'Änderungen der Datenschutzrichtlinie'
  },
  privacyPolicyChangesText: {
    el: 'Ενδέχεται να ενημερώνουμε την πολιτική αυτή περιοδικά.',
    en: 'We may update this policy periodically.',
    de: 'Wir können diese Richtlinie regelmäßig aktualisieren.'
  },
